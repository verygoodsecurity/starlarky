...
def Base24TestCase_test_decode_encode():
    ...
    asserts.assert_that(decoded['p']).is_equal_to('F63EC41128F18018')
    asserts.assert_that(decoded['1']).is_equal_to('000000001000012C')
    asserts.assert_that(decoded['2']).is_equal_to('4111111111111111')
    asserts.assert_that(decoded['14']).is_equal_to('2503')
    asserts.assert_that(decoded['35']).is_equal_to('4111111111111111=2503')
    asserts.assert_that(decoded['43']).is_equal_to('GOOGLE *TEMPORARY HOLDg.co/helppay#   GB')
    asserts.assert_that(decoded['60']).is_equal_to('VISAB017+0000000')
