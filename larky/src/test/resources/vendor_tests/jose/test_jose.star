...
def test_decrypt_GCM256_AES_wrapped_key_jwe_failing():
    jweString = "eyJlbmMiOiJBMjU2R0NNIiwidGFnIjoiazhaNnpTNjRJclllaUNpNV9JaWY5QSIsImFsZyI6IkEyNTZHQ01LVyIsIml2IjoieW9sTk8xLVFXSVg3R1poSCJ9.knPF3qV22v0pE-N6oUzlSIoBUEjr_k3sfFyYX-XuSH8.XkADjU0P2phiynPA.cvCd.Wp5oFTRAzEIFN8pImDnhmw"
    encryptionKey = bytes('96a18c1acc0b48beb9b24479355b70b5', encoding='utf-8')
    payload = jwe.decrypt(bytes(jweString, encoding='utf-8'), encryptionKey)
    asserts.assert_that(payload).is_equal_to(bytes('599', encoding='utf-8'))
