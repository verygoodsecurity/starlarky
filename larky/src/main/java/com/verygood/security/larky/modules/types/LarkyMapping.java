...
public interface LarkyMapping<K, V> extends Map<K, V>, LarkyIndexable, Mutability.Freezable, StarlarkIterable<K> {
  ...
  default Object getIndex(StarlarkThread thread, StarlarkSemantics semantics, Object key) throws EvalException {
    Object v;
    try {
      v = LarkyIndexable.super.getIndex(thread, semantics, key);
  ...
  @Override
  default void setIndex(StarlarkThread thread, StarlarkSemantics semantics, Object key, Object value) throws EvalException {
    putEntry((K) key, (V) value);
  }
