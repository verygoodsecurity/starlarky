...
public class BinasciiModule implements StarlarkValue {
  ...
  public LarkyByteArray a2b_base64(String s, StarlarkThread thread) throws EvalException {
    return new LarkyByteArray(thread, b64decode(s.getBytes(StandardCharsets.US_ASCII)));
  }
  ...
  @StarlarkMethod(name = "a2b_hex",
      ...
      useStarlarkThread = true)
  public LarkyByteArray a2b_hex(String hexstr, StarlarkThread thread) throws EvalException {
    ...
    return new LarkyByteArray(thread, output);
  }
  ...
  @StarlarkMethod(name = "b2a_base64",
      ...
      useStarlarkThread = true)
  public LarkyByteArray b2a_base64(LarkyByteArray data, Boolean newline, StarlarkThread thread) throws EvalException {
    byte[] encoded;
    try {
    ...
    return new LarkyByteArray(thread, encoded);
...
//  @Builtin(name = "hexlify", minNumOfPositionalArgs = 1)
  ...
  public String b2a_hex(LarkyByteArray binstr, Object sep, StarlarkInt bytes_per_sep) {
  ...
  public StarlarkInt crc32(LarkyByteArray data, StarlarkInt value) {
