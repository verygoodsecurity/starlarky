...
/**
 * ReardWriteDataBuffer - Input/Output utility.
 */
public final class ReadWriteDataBuffer implements DataInput, DataOutput, ObjectInput, ObjectOutput {

  private int pos = 0;
  private int count = 0;
  private byte[] buf;

  public ReadWriteDataBuffer() {
    buf = new byte[8];
  }

  public ReadWriteDataBuffer(byte[] data) {
    buf = data;
    count = data.length;
  }
  ...
  public ReadWriteDataBuffer reset() {
    pos = 0;
    count = 0;
    return this;
  }
  ...
  public ReadWriteDataBuffer reset(byte[] b) {
    pos = 0;
    buf = b;
    count = b.length;
    return this;
