...
public abstract class DelegateConsole implements Console {
  ...
  public void startupMessage(String version) {
    handleMessage(Message.MessageType.INFO, "Copybara source mover (Version: " + version + ")");
    delegate.startupMessage(version);
  }

  @Override
  public void error(String message) {
    handleMessage(Message.MessageType.ERROR, message);
    delegate.error(message);
  }

  @Override
  public void warn(String message) {
    handleMessage(Message.MessageType.WARNING, message);
  ...
  public void info(String message) {
    handleMessage(Message.MessageType.INFO, message);
    delegate.info(message);
  }

  @Override
  public void progress(String message) {
    handleMessage(Message.MessageType.PROGRESS, message);
    delegate.progress(message);
  }

  @Override
  public void verbose(String message) {
    handleMessage(Message.MessageType.VERBOSE, message);
  ...
  abstract protected void handleMessage(Message.MessageType info, String message);
}
