...
import static com.verygood.security.larky.config.ValidationResult.Level.ERROR;
import static com.verygood.security.larky.config.ValidationResult.Level.WARNING;

/**
 * The immutable result of a validation
 */
public class ValidationResult {
  ...
  public ImmutableList<String> getErrors() {
    ImmutableList<String> collect = messages.stream()
