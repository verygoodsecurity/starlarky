...
"""
load("@vendor//pyasn1/codec/der", decoder="decoder", encoder="encoder")
load("@vendor//pyasn1/type", namedtype="namedtype", univ="univ")

RSA_ENCRYPTION_ASN1_OID = "1.2.840.113549.1.1.1"
def RsaAlgorithmIdentifier():
...
def rsa_public_key_pkcs8_to_pkcs1(pkcs8_key):
    ...
    try:
        ...
        fail(" ValueError(\"Invalid public key encoding.\")")
