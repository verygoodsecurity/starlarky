...
def PKCS1OAEP_Cipher(key, hashAlgo, mgfunc, label, randfunc):
    ...
    self = larky.mutablestruct(__class__='PKCS1OAEP_Cipher')

    def __init__(key, hashAlgo, mgfunc, label, randfunc):
        ...
        return self
    self = __init__(key, hashAlgo, mgfunc, label, randfunc)
...
PKCS1_OAEP = larky.struct(
    new=new,
    PKCS1OAEP_Cipher=PKCS1OAEP_Cipher,
)