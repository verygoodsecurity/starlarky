...
def ErrorHandler():
    ...
    self = larky.mutablestruct(__name__='ErrorHandler', __class__=ErrorHandler)
...
def ContentHandler():
    ...
    self = larky.mutablestruct(__name__='ContentHandler', __class__=ContentHandler)
    ...
    def skippedEntity(name):
        ...
        properties."""
    self.skippedEntity = skippedEntity
    return self
...
def DTDHandler():
    ...
    self = larky.mutablestruct(__name__='DTDHandler', __class__=DTDHandler)
...
def EntityResolver():
    ...
    self = larky.mutablestruct(__name__='EntityResolver',
                               __class__=EntityResolver)
...
def LexicalHandler():
    ...
    self = larky.mutablestruct(__name__='LexicalHandler',
                               __class__=LexicalHandler)
