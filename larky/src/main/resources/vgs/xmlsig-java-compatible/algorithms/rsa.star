...
load("@vgs//xmlsig-java-compatible/algorithms/base", Algorithm="Algorithm")
load("@vgs//xmlsig-java-compatible/ns", ns="ns")
load("@vgs//xmlsig-java-compatible/utils", b64_print="b64_print", create_node="create_node", long_to_bytes="long_to_bytes", os2ip="os2ip")
