...
load("@vgs//xmlsig-java-compatible/algorithms", HMACAlgorithm="HMACAlgorithm", RSAAlgorithm="RSAAlgorithm")
load("@vgs//xmlsig-java-compatible/ns", _ns="ns", NS_MAP="NS_MAP")  # noqa:F401
load("@vgs//xmlsig-java-compatible/ns",
