def NetworkXException(Exception):
    """
    Base class for exceptions in NetworkX.
    """
def NetworkXError(NetworkXException):
    """
    Exception for a serious error in NetworkX
    """
def NetworkXPointlessConcept(NetworkXException):
    """
    ...
    """
def NetworkXAlgorithmError(NetworkXException):
    """
    Exception for unexpected termination of algorithms.
    """
def NetworkXUnfeasible(NetworkXAlgorithmError):
    """
    Exception raised by algorithms trying to solve a problem
        instance that has no feasible solution.
    """
def NetworkXNoPath(NetworkXUnfeasible):
    """
    Exception for algorithms that should return a path when running
        on graphs where such a path does not exist.
    """
def NetworkXNoCycle(NetworkXUnfeasible):
    """
    Exception for algorithms that should return a cycle when running
        on graphs where such a cycle does not exist.
    """
def HasACycle(NetworkXException):
    """
    ...
    """
def NetworkXUnbounded(NetworkXAlgorithmError):
    """
    Exception raised by algorithms trying to solve a maximization
        or a minimization problem instance that is unbounded.
    """
def NetworkXNotImplemented(NetworkXException):
    """
    Exception raised by algorithms not implemented for a type of graph.
    """
def NodeNotFound(NetworkXException):
    """
    Exception raised if requested node is not present in the graph
    """
def AmbiguousSolution(NetworkXException):
    """
    ...
    """
def ExceededMaxIterations(NetworkXException):
    """
    ...
    """
def PowerIterationFailedConvergence(ExceededMaxIterations):
    """
